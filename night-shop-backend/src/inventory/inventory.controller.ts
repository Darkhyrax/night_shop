...
export class InventoryController {
  ...
  @Post('batches')
  createBatch(@Body() createInventoryBatchDto: CreateInventoryBatchDto): Promise<InventoryBatch> {
  ...
  findBatchesByProduct(@Param('productId') productId: string): Promise<InventoryBatch[]> {
